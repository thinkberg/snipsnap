...
public class HelloSnipMacroExample extends TestCase {
  ...
  public HelloSnipMacroExample(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(HelloSnipMacroExample.class);
  }

  public void testHelloSnipMacro() {
    ...
    Macro macro = new HelloSnipMacro();
    ...
    assertEquals("HelloSnipMacro renders correct.", "hello", writer.toString());
  }
}
