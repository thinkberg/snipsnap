<%@ page import="org.snipsnap.snip.SnipSpace,
                 ...
                 org.snipsnap.user.UserManagerFactory"%>
 <!--
  ** Welcome screen
...
<div class="admin">
 ...
 <table>
  <tr><td><b>Administrator:</b></td><td>
   <a href="space/${config.adminLogin}"><c:out value="${config.adminLogin}"/></a>
  ...
  <tr><td><b>Registered Users:</b></td><td><%= UserManagerFactory.getInstance().getAll().size() %></td></tr>
  <tr><td><b>Stored Snips:</b></td><td><%= SnipSpaceFactory.getInstance().getAll().size() %></td></tr>
 </table>
 <div>
  <h3>Select one of the following actions:</h3>
  <ul class="square">
   <li><a href="manager/usermanager.jsp">Manage Registered Users</a></li>
   <li><a href="manager/export.jsp">Export Database to XML</a></li>
   <li><a href="manager/import.jsp">Import into Database from XML</a></li>
  </ul>
 </div>
</div>
