...
<s:check roles="Authenticated" permission="Edit" snip="${snip}">[<a href="<c:out value='${app.configuration.path}'/>/exec/new"><fmt:message key="menu.new"/></a>]</s:check>
...
[ <a href="<c:out value='${app.configuration.path}'/>/rdf/<c:out value='${snip.nameEncoded}'/>">rdf</a> ]
