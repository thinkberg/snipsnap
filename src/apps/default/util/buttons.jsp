...
<s:check roles="Editor" snip="${snip}">[<a href="<c:out value='${app.configuration.path}'/>/exec/remove?name=<c:out value='${snip.nameEncoded}'/>">zap!</a>]</s:check>
...
<s:check roles="Authenticated" permission="Edit" snip="${snip}">[<a href="<c:out value='${app.configuration.path}'/>/exec/upload?name=<c:out value='${snip.nameEncoded}'/>">attach</a>]</s:check>
<s:check roles="Authenticated" permission="Edit" snip="${snip}" invert="true"><span class="inactive">[attach]</span></s:check>
<s:check roles="Authenticated">[<a href="<c:out value='${app.configuration.path}'/>/exec/labels?snipname=<c:out value='${snip.nameEncoded}'/>">labels</a>]</s:check>
